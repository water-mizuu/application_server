...
Future<void> main() async {
  ...
  // TODO(water-mizuu): Create a fallback for when network tools takes too long.
  //  - Preferrably manual input.
  await initializeNetworkTools().timeout(
    2.seconds,
    onTimeout: () {
      printDebug("Network tools initialization timed out.");
    },
  );
